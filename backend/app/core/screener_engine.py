...
MASTER_STOCK_UNIVERSE: List[ScreenerStockItem] = [
    ...
    ScreenerStockItem(ticker="PICCADIL.BO", company_name="Piccadily Agro Industries", sector="Distillery & Beverages", market_cap_cr=6260.8, price=635.15, pe=44.08, pb=14.2, roe=38.4, roce=42.1, debt_to_equity=0.18, return_1y=280.5, div_yield=0.25, quality_score=86.0),
